window.addEventListener('load', function(){
    ...
    update(){
        ...
        this.x += (this.vx *= this.friction) + (this.originX - this.x) * this.ease*0.1;
        this.y += (this.vy *= this.friction) + (this.originY - this.y) * this.ease*0.1;
        }
    }
    ...
    class Effect {
        ...
        init(context){
            ...
            for(var y = 0; y < this.height; y += this.gap) {
                for(var x = 1; x < this.width; x += this.gap) {
